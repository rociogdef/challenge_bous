...
--\copy challenge_bous.adeudos from 'adeudos_aux.csv' with delimiter ',' csv encoding 'windows-1251';
\copy challenge_bous.adeudos from 'adeudos_aux.csv' with delimiter ',' csv encoding 'utf-8';
...
\copy challenge_bous.registros_incorrectos to 'Reg_incorrectos.csv' WITH (FORMAT CSV, HEADER);
\copy challenge_bous.registros_correctos to 'Reg_correctos.csv' WITH (FORMAT CSV, HEADER);
